...
// SolarPanel.html
bar += '<a id="SolarPanel" class="dropdown-item" href="SolarPanel.html">Solar Panels</a>';
// micro.html
bar += '<a id="micro" class="dropdown-item" href="micro.html">Computers & Microcontrollers</a>';
// RFID.html
bar += '<a id="RFID" class="dropdown-item" href="RFID.html">RFID</a>';
// motors.html
bar += '<a id="motors" class="dropdown-item" href="motors.html">Motors</a>';
bar += '</div>';
bar += '</li>';
